...
public class PersistenciaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente c1 = new Cliente(null, "33235678911", "Teste Dias de Oliveira", "teste@email.com", TipoCliente.PESSOA_FISICA);
		Cliente c2 = new Cliente(null, "12345678901", "Emerson Dias de Oliveira", "emerson@email.com", TipoCliente.PESSOA_FISICA);

		Endereco end1 = new Endereco(null, "Rua Tiradentes", "300", "Apto 124", "Centro", "19920-123", true, c2, cidade1);
		Endereco end2 = new Endereco(null, "Rua Tiradentes", "100", null, "Centro", "19920-123", false, c2, cidade2);
		Endereco end3 = new Endereco(null, "Rua das Flores", "128", "Fundos", "Jardim das Flores", "65788-002", false, c1, cidade3);
